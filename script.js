    ...
    document.getElementById('phones-list').innerHTML = filtered.map(p => `
        <div class="phone-card" onclick="showPhone(${p.id})">
            <div class="phone-images">
                <img src="${p.img}" alt="${p.fullName}" onerror="this.src='https://via.placeholder.com/300x400/f0f0f0/666666?text=Фото+не+найдено'" loading="lazy">
                <img src="${p.img2}" alt="${p.fullName}" onerror="this.src='https://via.placeholder.com/300x400/f0f0f0/666666?text=Фото+не+найдено'" loading="lazy">
            </div>
            <h3>${p.fullName}</h3>
