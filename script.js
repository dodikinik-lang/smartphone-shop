...
tg.ready(); tg.expand();
const phones = [
    {id:1,fullName:"Samsung Galaxy A17",variant:"4Gb/128Gb чёрный EAC",img:"https://c.dns-shop.ru/thumb/st1/fit/0/0/5b0e5eb8182a1e2056be02116e6803ad/eb7c91fad4ab7862ab7f353bc066f0a2b01d40dac49b5bfb2937e8708f46ac32.jpg",img2:"https://images.samsung.com/is/image/samsung/p6pim/ie_en/smartphones/galaxy-a/galaxy-a17-5g-black-128gb-sm-a176bzkaeub/gallery/ie-en-galaxy-a17-5g-sm-a176-sm-a176bzkaeub-549435873?$L174_FB_EC_GMP_L14$",oldPrice:15999,newPrice:14999,specs:["6.5\" PLS","Helio G85","50MP","5000 mAh"],brand:"Samsung"},
    ...
    document.getElementById('phones-list').innerHTML = filtered.map(p => `
        <div class="phone-card" onclick="showPhone(${p.id})">
            <div class="phone-images">
                <img src="${p.img}" alt="${p.fullName}" onerror="this.src='https://via.placeholder.com/300x400/f0f0f0/000000?text=No+Photo'" loading="lazy">
                <img src="${p.img2}" alt="${p.fullName}" onerror="this.src='https://via.placeholder.com/300x400/f0f0f0/000000?text=No+Photo'" loading="lazy">
            </div>
            <h3>${p.fullName}</h3>
...
function showPhone(id) {
    ...
    document.getElementById('detail-img').onerror = () => { document.getElementById('detail-img').src = 'https://via.placeholder.com/300x600/f0f0f0/000000?text=No+Photo'; };
